...
* since gemini api doesnt have unlimited context window for input and output, the text for each video gets devided into chunks(right now chunk size is set to 3000 after testing but it can be changed)
